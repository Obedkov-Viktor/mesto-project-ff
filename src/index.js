...
import {initialCards, createCard} from "./components/cards";
...
const popupProfileOpenButton = document.querySelector('.popup_type_edit');
...
editButton.addEventListener('click', () => openModal(popupProfileOpenButton));
